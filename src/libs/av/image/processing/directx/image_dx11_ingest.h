...
class AVEXPORT ImageDx11IngestNode : public titan::utility::ProcessingNode {
public:
    enum Params {
        kInput = 0,
        kOutput = 1,
    ...
    explicit ImageDx11IngestNode(const titan::system::win32::D3d11SharedDevicePtr& device);
private:
