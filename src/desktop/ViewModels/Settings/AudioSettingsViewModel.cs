...
{
    public class AudioSettingsViewModel : ReactiveObject, IRoutableViewModel
    {
        public Models.Localization.Localization Loc { get; } = Locator.Current.GetService<Models.Localization.Localization>()!;
        public IScreen HostScreen { get; }
        public string UrlPathSegment { get; } = "/audio";
        public AudioSettingsViewModel(IScreen parent)
        {
            HostScreen = parent;
        }
    }
