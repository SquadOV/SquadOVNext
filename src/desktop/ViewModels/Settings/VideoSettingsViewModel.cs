...
{
    public class VideoSettingsViewModel : ReactiveObject, IRoutableViewModel
    {
        public Models.Localization.Localization Loc { get; } = Locator.Current.GetService<Models.Localization.Localization>()!;
        public IScreen HostScreen { get; }
        public string UrlPathSegment { get; } = "/video";
        public VideoSettingsViewModel(IScreen parent)
        {
            HostScreen = parent;
        }
    }
