...
{
    public class OverlaySettingsViewModel : ReactiveObject, IRoutableViewModel
    {
        public Models.Localization.Localization Loc { get; } = Locator.Current.GetService<Models.Localization.Localization>()!;
        public IScreen HostScreen { get; }
        public string UrlPathSegment { get; } = "/overlay";
        public OverlaySettingsViewModel(IScreen parent)
        {
            HostScreen = parent;
        }
    }
